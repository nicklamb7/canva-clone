...
function Sidebar() {
  return (
    <div className="sidebar">
      ...
      <button>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-nut" viewBox="0 0 16 16">
